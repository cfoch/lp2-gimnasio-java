 ...
 * @author alulab14
 */
public class Vcliente_modPerfil extends javax.swing.JPanel {

    /**
     * Creates new form Vcliente_modPerfil
     */
    public Vcliente_modPerfil() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtApMat.setBackground(new java.awt.Color(240, 240, 240));
        txtApMat.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtApMat.setForeground(new java.awt.Color(117, 126, 131));
        txtApMat.setText("XXXX-XXXX-XXXX-XXXX");
        txtApMat.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(200, 149, 90)));
        ...
        txtFecNac.setBackground(new java.awt.Color(240, 240, 240));
        txtFecNac.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtFecNac.setForeground(new java.awt.Color(117, 126, 131));
        txtFecNac.setText("XXXX-XXXX-XXXX-XXXX");
        txtFecNac.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(200, 149, 90)));
        ...
        txtNomb.setBackground(new java.awt.Color(240, 240, 240));
        txtNomb.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtNomb.setForeground(new java.awt.Color(117, 126, 131));
        txtNomb.setText("XXXX-XXXX-XXXX-XXXX");
        txtNomb.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(200, 149, 90)));
        ...
        txtApPat.setBackground(new java.awt.Color(240, 240, 240));
        txtApPat.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtApPat.setForeground(new java.awt.Color(117, 126, 131));
        txtApPat.setText("XXXX-XXXX-XXXX-XXXX");
        txtApPat.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(200, 149, 90)));
        ...
        txtEmail.setForeground(new java.awt.Color(117, 126, 131));
        txtEmail.setText("XXXX-XXXX-XXXX-XXXX");
        txtEmail.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(200, 149, 90)));
        ...
        txtTel.setForeground(new java.awt.Color(117, 126, 131));
        txtTel.setText("XXXX-XXXX-XXXX-XXXX");
        txtTel.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(200, 149, 90)));
        ...
        txtDistrito.setBackground(new java.awt.Color(240, 240, 240));
        txtDistrito.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtDistrito.setForeground(new java.awt.Color(117, 126, 131));
        txtDistrito.setText("XXXX-XXXX-XXXX-XXXX");
        txtDistrito.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(200, 149, 90)));
        ...
        txtDireccion.setForeground(new java.awt.Color(117, 126, 131));
        txtDireccion.setText("XXXX-XXXX-XXXX-XXXX");
        txtDireccion.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(200, 149, 90)));
        ...
        btnModPerfil.setBackground(new java.awt.Color(50, 54, 56));
    ...
    private void btnModPerfilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModPerfilActionPerformed
        Vcliente_perfil ventPerfil = new Vcliente_perfil();
